...
class PersonalDetail(forms.Form):
    ...
    pickUpDate = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control px-4'}))
    pickUpTime = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control px-4'}))
